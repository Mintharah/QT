...
public:
    explicit VehicleBackend(const QString &csvPath, QObject *parent = nullptr);
    ...
    // For a 12V lead-acid pack (your CSV range is 10.0 – 12.6V)
...
private:
    void loadCsv();
    void tick();
    void applyRow(const QStringList &row);
